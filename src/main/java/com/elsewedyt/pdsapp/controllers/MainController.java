...
import com.elsewedyt.pdsapp.services.ShiftManager;
...
public class MainController implements Initializable {
    ...
    @FXML
    private ImageView pds_image_view;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
       // Set focus to welcome label
        ...
        Image img2 = new Image(MainController.class.getResourceAsStream("/images/pdshome.png"));
