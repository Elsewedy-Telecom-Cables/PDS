package com.etc.pds.excel.service;
import com.etc.pds.excel.core.StageExcelService;
import com.etc.pds.excel.core.StageValidator;
import com.etc.pds.excel.core.StageProcessor;
import com.etc.pds.excel.util.ExcelUtils;
import com.etc.pds.model.Braid;
import com.etc.pds.excel.validator.BraidValidator;
import com.etc.pds.excel.processor.BraidProcessor;
...
public class BraidExcelHandler
        implements StageExcelService<Braid>, StageValidator<Braid>, StageProcessor<Braid> {
    ...
    @Override
    public List<Braid> importFromExcel(File file) throws IOException {
    ...
    @Override
    public List<String> validate(List<Braid> items) {
