...
import com.etc.pds.dao.MachineDao;
import com.etc.pds.dao.SectionDao;
import com.etc.pds.logging.Logging;
import com.etc.pds.model.Machine;
import com.etc.pds.model.Section;
...
public class CoreTables2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Image img = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/etc_logo.png")));
