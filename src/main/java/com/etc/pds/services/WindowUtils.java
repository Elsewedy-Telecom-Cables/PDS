...
import com.etc.pds.controller.UserController;
import com.etc.pds.controller.LoginController;
import com.etc.pds.db.DEF;
...
import static com.etc.pds.logging.Logging.ERROR;
import static com.etc.pds.logging.Logging.logException;
...
public class WindowUtils {
    ...
    public static void OPEN_WINDOW_FULL_SCREEN2(String fxmlPath, Runnable onCloseAction) {
        try {
            Parent root = FXMLLoader.load(WindowUtils.class.getResource(fxmlPath));
            Scene scene = new Scene(root);
            Stage stage = new Stage();
    ...
    public static String iconImagePath = "/images/pdshome.png";
    ...
    public static final String  ADD_PREPARE_DATA = "/screens/CoreTables2.fxml";
    public static final String  ADD_UPDATE_PDS_DATA = "/screens/CoreTables.fxml";
    ...
    public static int getUserRoleInt(String role) {
        if (DEF.USER_ROLE_GENERAL_USER_STRING.equals(role)) {
            return 1;
    ...
    public static String getUserRoleStr(int roleId) {
        if (roleId == 1) {
            return DEF.USER_ROLE_GENERAL_USER_STRING;
        } else if (roleId == 2) {
