...
public class SectionDao {
        ...
        public  int insertSection(Section section) {
            String query = """
            INSERT INTO pds.dbo.sections (section_name) VALUES (?)
            """;
            int generatedId = -1;
        ...
        public  boolean updateSection(Section section) {
            String query = """
            UPDATE pds.dbo.sections
            SET section_name = ? WHERE section_id = ?
            """;
