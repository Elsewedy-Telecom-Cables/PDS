...
public class ViewUsersController implements Initializable {
    ...
    @FXML private TableColumn<User, String> active_colm;

    @FXML private TableColumn<User, String> creationDate_colm;

    @FXML private TableColumn<User, String> edit_colm;

    @FXML private TableColumn<User, String> empId_colm;

    @FXML private TableColumn<User, String> fullname_colm;

    @FXML private TableColumn<User, String> phone_colm;

    @FXML private TableColumn<User, String> role_colm;

    @FXML private TextField filterUsers_txtF;


    @FXML private TableColumn<User, String> userId_colm;

    @FXML private TableColumn<User, String> user_password_colm;

    @FXML private TableColumn<User, String> username_colm;

    @FXML private TextField users_count_textF;

    @FXML private Label users_num_lable;

    @FXML private TableView<User> users_tbl_view;
   ...
   private final UserDao userDao = AppContext.getInstance().getUserDao();
    ...
    private void loadData() {
        Platform.runLater(() -> {
            ...
            user_password_colm.setStyle("-fx-alignment: CENTER; -fx-font-size: 13px;-fx-font-weight:bold");
        ...
        filterUsers_txtF.textProperty().addListener((observable, oldValue, newValue) -> {
            filteredData.setPredicate(user -> {  // object from Meals
                ...
                if (user.getUserName().toLowerCase().contains(lowerCaseFilter)) {
                    ...
                    return true;
                } else if (user.getCreationDate().toLowerCase().contains(lowerCaseFilter)) {
                    return true;
